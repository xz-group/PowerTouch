"""
   ...
   The FDwfDigitalIn functions decode SPI ad2_data.
"""
...
try:
    while True:
        txt = input("\nType ad2_data array to send and press enter, like: 1 2 3  To quit press Ctrl+C\n")
        if len(txt) == 0:
            break
        ...
        dwf.FDwfDigitalInStatusData(hdwf, rgdwSamples, c_int(cAvailable.value * 4))  # 32bit ad2_data
