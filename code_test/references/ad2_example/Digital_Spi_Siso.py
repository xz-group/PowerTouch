...
dwf.FDwfDigitalSpiWrite(hdwf, c_int(0), c_int(8), rgbTX,
                        c_int(len(rgbTX)))  # write from array of 8bit (byte) elements in 8 bit ad2_data lengths
dwf.FDwfDigitalSpiRead16(hdwf, c_int(0), c_int(12), rgwRX,
                         c_int(len(rgwRX)))  # read to array of 16 bit (short) elements in 12bit ad2_data lengths
dwf.FDwfDigitalSpiSelect(hdwf, c_int(0), c_int(1))  # CS DIO-0 high
