...
print("Reference: " + str(reference) + " Ohm  Frequency: " + str(freq) + " Hz Offset: " + str(start) + " V ... " + str(
    stop) + " V")
...
dwf.FDwfAnalogImpedanceFrequencySet(hdwf, c_double(freq))  # frequency_kHz in Hertz
