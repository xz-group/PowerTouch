...
rgc1 = (c_double * 5000)()
rgc2 = (c_double * 5000)()
dwf.FDwfAnalogInStatusData(hdwf, c_int(0), rgc1, len(rgc1))  # get channel 1 ad2_data
dwf.FDwfAnalogInStatusData(hdwf, c_int(1), rgc2, len(rgc2))  # get channel 2 ad2_data
