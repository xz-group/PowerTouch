"""
   ...
   - records ad2_data on Scope 1
   - writes ad2_data to 16 bit WAV file
"""
...
try:
    while cSamples < nSamples:
        ...
        dwf.FDwfAnalogInStatusData16(hdwf, c_int(0), rgSamples, c_int(0), cAvailable)  # get channel 1 ad2_data chunk
