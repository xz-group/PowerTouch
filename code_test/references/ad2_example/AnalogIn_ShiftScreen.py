...
try:
    while True: #time.time()-start < 10:
        ...
        dwf.FDwfAnalogInStatusData(hdwf, c_int(0), byref(rgdSamples), cValid)  # get channel 1 ad2_data
        # dwf.FDwfAnalogInStatusData(hdwf, c_int(1), byref(rgdSamples), cValid) # get channel 2 ad2_data
        # print(cValid.value)
