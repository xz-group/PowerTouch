...
while cSamples < nSamples:
    ...
    dwf.FDwfAnalogInStatusData16(hdwf, c_int(0), byref(rgSamples, sizeof(c_int16) * cSamples), c_int(0),
                                 cAvailable)  # get channel 1 ad2_data
    # dwf.FDwfAnalogInStatusData16(hdwf, c_int(1), byref(rgSamples, sizeof(c_int16)*cSamples), c_int(c), Available) # get channel 2 ad2_data
