...
dwf.FDwfAnalogImpedanceFrequencySet(hdwf, c_double(frequecy)) # frequency_kHz in Hertz
dwf.FDwfAnalogImpedanceAmplitudeSet(hdwf, c_double(1))
dwf.FDwfAnalogImpedanceConfigure(hdwf, c_int(1)) # start
time.sleep(2)

if True:
    # open compensation is important for high frequency_kHz or high resistor values
