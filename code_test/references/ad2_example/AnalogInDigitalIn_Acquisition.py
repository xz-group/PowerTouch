...
#sample rate = system frequency_kHz / divider, 100MHz/1
...
dwf.FDwfAnalogInStatusData(hdwf, c_int(0), rgdAnalog, c_int(cSamples))  # get channel 1 ad2_data
# dwf.FDwfAnalogInStatusData(hdwf, 1, rgdAnalog, cSamples) # get channel 2 ad2_data
