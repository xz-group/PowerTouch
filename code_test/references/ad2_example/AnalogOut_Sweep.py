...
dwf.FDwfAnalogInStatusData(hdwf, c_int(0), rgdSamples1, len(rgdSamples1))  # get channel 1 ad2_data
dwf.FDwfAnalogInStatusData(hdwf, c_int(1), rgdSamples2, len(rgdSamples2))  # get channel 2 ad2_data

dwf.FDwfDeviceCloseAll()

plt.plot(numpy.linspace(0, cSamples - 1, cSamples), numpy.fromiter(rgdSamples1, dtype=numpy.float),
         numpy.linspace(0, cSamples - 1, cSamples), numpy.fromiter(rgdSamples2, dtype=numpy.float))
plt.show()
