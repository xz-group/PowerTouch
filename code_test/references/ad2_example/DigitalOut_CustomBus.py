"""
   ...
   Captures 32 samples having the generated ad2_data in middle
"""
...
# sample rate = sy﻿stem frequency_kHz ﻿/ divider, for Digital Discovery 800MHz/8 = 100MHz sample rate
